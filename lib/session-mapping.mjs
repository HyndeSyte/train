...
// RP..RPr = current ring-spine rotation. U1/L1/U2/L2 = retired pre-v4 types, accepted ONLY so
// existing history backfills faithfully; new sessions never emit them. Still a controlled enum.
export const SESSION_TYPES = ['RP', 'LP', 'RPush', 'LS', 'RPr', 'U1', 'L1', 'U2', 'L2'];
